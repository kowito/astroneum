...
import type { CandleData, NeighborData } from '../common/Data'
...
export type IndicatorCreateTooltipDataSourceCallback<D> = (params: IndicatorCreateTooltipDataSourceParams<D>) => Partial<IndicatorTooltipData>
...
export type IndicatorCalcCallback<D, C, E> = (dataList: CandleData[], indicator: Indicator<D, C, E>) => Promise<D[]> | D[]
