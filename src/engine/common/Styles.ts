...
import type { CandleData, NeighborData } from './Data'
...
export type CandleTooltipLegendsCustomCallback = (data: NeighborData<Nullable<CandleData>>, styles: CandleStyle) => TooltipLegend[]
